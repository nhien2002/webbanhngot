...
if($_FILES["fileHinhBanh"]["name"]!="")
{
    ...
    echo ("<script language=javascript>
    alert('Đổi ảnh sản phẩm và Sửa thành công'); window.location='QT_xembanhtheoloai.php?ml=$ml';
    </script> ");
}
else
{
    ...
    echo ("<script language=javascript>
    alert('Sửa thành công'); window.location='QT_xembanhtheoloai.php?ml=$ml';
    </script> ");
}
?>
