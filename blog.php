        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                ...
                <div class="col-lg-5 col-md-6 col-sm-6" >
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="img/footer_logo_nhien.png" alt=""></a>
                        </div>
                        <p>Sản phẩm đồ án chuyên ngành đề tài:website bán bánh ngọt  
                        <br>Sinh viên thực hiện: Nguyễn Huỳnh Nhiên-110120053 </p>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <p class="copyright__text text-white"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                          Copyright &copy;<script>document.write(new Date().getFullYear());</script>websitebanhngothuynhnhien
